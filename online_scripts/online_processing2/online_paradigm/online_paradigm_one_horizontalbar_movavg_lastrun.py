...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\gattr\\Desktop\\BCI_Racingteam\\main\\mirage91\\online_scripts\\online_processing2\\online_paradigm\\online_paradigm_one_horizontalbar_movavg_lastrun.py',
        ...
        for thisTrial in trials:
            ...
            while continueRoutine:
                ...
                if np.size(chunk) > 0:
                    ...
                    cur_class_probs, zi = signal.lfilter(b,a,chunk, zi=zi)
